...
inquirer
	...
	.then(function (respuestas) {
		...
		// algo que no hacer es pisar los datos, por ejemplo
			// si cargas respuestas.nombre = 'pepito' queda guardado este ultimo ;
		//AGREGANDO LA FECHA Y LA HORA AL OBJETO RESPUESTAS;
		respuestas.fechaDelPedido = fecha.toLocaleDateString();
		respuestas.horaDelPedido = fecha.toLocaleTimeString();

		// AGREGANDO AL OBJETO RESPUESTAS VARIOS POPS !
		respuestas.totalPedido = precioFinal;
